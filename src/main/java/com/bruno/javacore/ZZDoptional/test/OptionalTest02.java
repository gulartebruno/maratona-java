...
import com.bruno.javacore.ZZDoptional.dominio.Manga;
import com.bruno.javacore.ZZDoptional.repositorio.MangaRepository;
...
public class OptionalTest02 {
    public static void main(String[] args) {
        ...
        Manga newManga = MangaRepository.findByTitle("Drifteres")
