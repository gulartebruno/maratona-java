...
public class ProducerRepository {
    public static void save(Producer producer) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while trying to insert poducer'{}'", producer.getName(), e);
            e.printStackTrace();
        }
    }
...
//                if (p.getName().equals("White fox")) throw new SQLException("Can't save white fox");
        ...
        if (shouldRollback) {
            log.warn("Transaction is going to be roolback");
            conn.rollback();
        }
    ...
    public static void delete(int id) {
        ...
        try (Connection conn = ConnectionFactory.getConnection();
            ...
            log.error("Error while trying to delete poducer'{}'", id, e);
            e.printStackTrace();
        }
    }
